...
public class VLogin extends javax.swing.JFrame {
    ...
    public VLogin() {
        ...
        // listener para esperar a que jLabel1 se renderice
        jLabel1.addComponentListener(new java.awt.event.ComponentAdapter() {
            @Override
            public void componentResized(java.awt.event.ComponentEvent evt) {
                // Cargar la imagen desde los recursos
                ImageIcon originalIcon = new ImageIcon(getClass().getResource("/images/piniateria_lizzety_logo.png"));

                // Redimensionar la imagen con las dimensiones actuales del JLabel
                Image resizedImage = originalIcon.getImage().getScaledInstance(jLabel1.getWidth(), jLabel1.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 200, 200));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(250, 123, 104));
        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel12.setText("Created By TheDanilore");
        ...
        jLabel4.setText("Hola! Inicia Sesión");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 94, 420, -1));

        jLabel5.setBackground(new java.awt.Color(228, 233, 239));
        ...
        jLabel8.setBackground(new java.awt.Color(228, 233, 239));
        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(239, 240, 242));
        ...
        jCheckBox1.setForeground(new java.awt.Color(239, 240, 242));
        jCheckBox1.setText("Remember Password");
        jPanel2.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(34, 261, -1, -1));

        jLabel11.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(239, 240, 242));
        ...
        jLabel10.setForeground(new java.awt.Color(239, 240, 242));
        jLabel10.setText("Piñateria Lizzety");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 380, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                vista = new VLogin();
                try {
                    LoginController controller = new LoginController(vista); // Aquí utilizas la variable manager de vista
