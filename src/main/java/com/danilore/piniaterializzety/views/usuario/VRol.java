 ...
 * @author ASUS
 */
public final class VRol extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTextoEditarOCrearPermiso.setText("ROL");
        ...
        jlistPermisosRoles.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ...
        jLabel22.setText("Permisos:");

        lblPermisos.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        lblPermisos.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblPermisos.setText("ubicacion desconocida");
        lblPermisos.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(76, 170, 255), 1, true));
